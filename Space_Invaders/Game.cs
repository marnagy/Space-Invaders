...
namespace Space_Invaders
{
    public class Game
    {
        ...
        {
            LeaderboardThing thisLeader = new LeaderboardThing(playerName, timeSpan, endScore.ToString());
            List<string> lines = new List<string>();
            listLB = new List<LeaderboardThing>();
            int i;
            {
                string fileName = "";
            ...
            for (i = 0; i < 30 && i < lines.Count; )
            {
                ...
                listLB.Add(new LeaderboardThing(tempName, tempTimespanLine, tempScore));
            }
            ResortLeaderboard(listLB, thisLeader);
            ShowLeaderboard();
            SaveLeaderboard();
        }
        void ResortLeaderboard(List<LeaderboardThing> list, LeaderboardThing playerLB)
        {
            int i;
            int inLB = 1;
        ...
        void ShowLeaderboard()
        {
            ...
            {
                LeaderboardThing temp = listLB[i];
