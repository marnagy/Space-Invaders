...
{
    public class LeaderboardThing
    {
        public readonly string name;
        public readonly TimeSpan time;
        public readonly int score;
        public LeaderboardThing(string nameLine, string timespanLine, string scoreLine)
        {
            name = nameLine;
        ...
        public LeaderboardThing(string nameLine, TimeSpan span, string scoreLine)
        {
            name = nameLine;
            time = span;
            score = int.Parse(scoreLine);
